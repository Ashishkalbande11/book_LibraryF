    ...
    const submit = async () => {
        try {
            if (bookData.url === "" || bookData.title === "" || bookData.author === "" || bookData.price === "" || bookData.desc === "" || bookData.language === "") {
                ...
                const res = await axios.post('https://booklibrarybackend-9e8y.onrender.com/api/add-book', bookData, { headers });
                setBookData({
                    url: "",
                    title: "",
                    author: "",
        ...
        <div className='h-[100%] p-0 md:p-4'>
            ...
            <div className='p-4 bg-zinc-800 rounded'>
                ...
                <div className='flex justify-end items-center px-4'>
                    <button onClick={submit} className='mt-4 px-3 bg-blue-500 text-white font-semibold py-2 rounded hover:bg-blue-600 transition-all duration-300 flex justify-end items-end'>Add Book</button>
                </div>
            </div>
        </div>
    )
